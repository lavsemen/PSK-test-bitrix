...
$MESS["DOCUMENT_FIRST_TIME_HINT_TEXT"] = "Складський облік починається з документа \"Оприбуткування товару\". Потрібно створити прибутття? Просто змініть тип документа";
